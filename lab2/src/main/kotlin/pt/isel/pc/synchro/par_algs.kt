...
private fun main() {
    ...
    // o array values fica populado com 2_000_000 de strings, metade referências para "str1" e
    // outra metade, referências para "str2"
    val values : Array<String>  = stringsMaker(2_000_000, templates)
    val ref = values[0]
    println(values[0])
    println(values[1])
